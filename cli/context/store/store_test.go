...
// The test payload is a tiny archive whose central directory declares an
// oversized TLS entry (patched after creation); this validates the
// UncompressedSize64 guard without allocating the bomb payload on the
// test heap.
func TestImportZipTLSTooLarge(t *testing.T) {
	// hand-crafted zip (meta.json + tls/docker/ca.pem) with CD entry for
	// the TLS file patched to claim UncompressedSize64 = 2 * 10MiB while
	// actual compressed payload stays tiny (~252 bytes total archive).
	bombZip := []byte{
		,
	}

	s := New(t.TempDir(), testCfg)
	err := Import("zipBomb", s, bytes.NewReader(bombZip))
